        ...
        public static Dictionary<string, Manifestacija> Manifestacije
        {
            get
            {
                if (manifestacije == null)
                {
                    ...
                    manifestacije.Add("1", new Manifestacija("1", "Primer1", "Opis1", "Alkohol se moze doneti", "Besplatno", true, true, false, 5000, "",
                        new BitmapImage(new Uri("images/slanina.png", UriKind.Relative)), "Tip1"));
                    manifestacije.Add("2", new Manifestacija("2", "Primer2", "Opis2", "Nema alkohola", "Visoke cene", false, true, false, 100, "",
                         new BitmapImage(new Uri("images/robot.png", UriKind.Relative)), "Tip2"));
